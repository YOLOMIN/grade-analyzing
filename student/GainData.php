...
where courseno='1' and score.studentno = any( select studentno from student where classno=A.classno)
GROUP BY time";

    $math_AVG="select distinct AVG(score) as math
from score,student,(select classno from student where studentno='$name1')as A
where courseno='2' and score.studentno = any( select studentno from student where classno=A.classno)
GROUP BY time";

    $english_AVG="select distinct AVG(score) as english
from score,student,(select classno from student where studentno='$name1')as A
where courseno='3' and score.studentno = any( select studentno from student where classno=A.classno)
GROUP BY time";

    $ChineseGradeAVG="select distinct AVG(score) as ChineseGrade
from score,student
where courseno='1' and score.studentno = any( select studentno from student where studentno like '2016%')
GROUP BY time";
    $MathGradeAVG="select distinct AVG(score) as MathGrade
from score,student
where courseno='2' and score.studentno = any( select studentno from student where studentno like '2016%')
GROUP BY time";
    $EnglishGradeAVG="select distinct AVG(score) as EnglishGrade
from score,student
where courseno='3' and score.studentno = any( select studentno from student where studentno like '2016%')
GROUP BY time";
}
if(isset($_POST['btn'])){
