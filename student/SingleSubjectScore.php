...
<div class="container">
    ...
    <div align="center">
        ...
        <span align="center">
                ...
                <?php
                if($page>1) {
                    echo "<a href=SingleSubjectScore.php?page=1><input class='btn' type='submit' value='首页'></a>";
                    echo "<a href=SingleSubjectScore.php?page=".($page - 1)."><input class='btn' type='submit' value='上一页'></a>";
        ...
        <apan align="center">
            ...
            if($page<$pageCount) {             //S_SESSION获取当前的网址
                echo "<a href=SingleSubjectScore.php?page=" . ($page + 1) . "><input class='btn' type='submit' value='下一页'></a>";
                echo "<a href=SingleSubjectScore.php?page=$pageCount><input class='btn' type='submit' value='尾页'></a>";
            }
            ?>
        </apan>
