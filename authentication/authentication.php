...
<body>
<form id="form1" action="abackstage.php" method="post" >
    ...
    <div style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 250px; text-align: center;">
        ...
        <p style="padding: 30px 0px 10px; position: relative;">
            <span class="u_logo"></span>         <input class="ipt" name="username" type="text" placeholder="请输入学号或工号" name="UserName">
        </p>
        <p style="position: relative;">
            <span class="p_logo"></span>
            <input class="ipt" name="userno" type="text" placeholder="请输入账号" name="userno">
        ...
        <p style ="margin: 40px 35px 10px 45px;">
            ...
            <span style="float:initial;">
                <input type="submit" name="UserLogin" value="验证" id="UserLogin" style="color:White;background-color:#008EAD;border-color:#008EAD;border-width:4px;border-style:solid;height:40px;width:224px;">
            </span>
        </p>
